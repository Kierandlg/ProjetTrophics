...
class Graph
{
    private :
        ...
        ///premiere valeur de nos fichiers txt, qui est le nombre de sommets que contient le graphe
        int m_nb_sommet;
        ///nombre d'arc que contient le graphe
        int m_nb_arc;

        std::vector<Vertex>m_sommet;
        std::vector<Edge>m_arc;
    ...
    public:
        ...
        void sauvegarder_graphe(int saisie);

        /// La méthode update à appeler dans la boucle de jeu pour les graphes avec interface
        void update();

        void enlever_arc(int eidx);
        void enlever_sommet(int eidx);
        void ToutesComposantesConnexes();
        std::vector<int> UneComposanteConnexe(int s, std::vector<std::vector<int>> adjacence);
        void ajouter_arc(int ind_arc,int somm_dep,int somm_ar,int weight);
        void ajouter_sommet(int ind_somm, int valeur, int x, int y ,std::string nom_image);
